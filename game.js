...
function create() {
    ...
    bg.tileScaleY = config.height / bg.height;

         // Adjust the background width to match the game width
    ...
    let ground = this.physics.add.staticSprite(0, 600, 'ground').setOrigin(0, 0).setDisplaySize(config.width, 150).refreshBody();
 ...
 playerHPText = this.add.text(16, 16, 'HP: 100', { fontSize: '32px', fill: '#fff' })
     .setScrollFactor(0)
